...
function RandomAccelerationMover(l, v) {
  this.location = l;
  this.velocity = v;
  this.topspeed = 10;
};
RandomAccelerationMover.prototype.checkEdges = function() {
...
RandomAccelerationMover.prototype.update = function() {
    this.location.add(this.velocity);
    this.velocity.add(PVector.random().scalar(.5));
    // this.velocity.limit(this.topspeed);
};
RandomAccelerationMover.prototype.display = function() {
  stroke(0);
  fill(175);
...
function setup() {
  ...
  mover = new RandomAccelerationMover(location, velocity);
}
